...
INELS_HACS_NUMBER_TYPES: dict[str, InelsHacsNumberType] = {
    "number": InelsHacsNumberType()
}
...
async def async_setup_entry(
    ...
    items = INELS_HACS_NUMBER_TYPES.items()
...
class InelsHacsBusNumber(InelsHacsBaseEntity, NumberEntity):
