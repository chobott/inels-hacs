...
INELS_HACS_SELECT_TYPES: dict[str, InelsHacsSelectType] = {
    "fan_speed": InelsHacsSelectType(
        name="Fan speed",
        icon=ICON_FAN,
...
@dataclass
class InelsHacsSelectEntityDescriptionMixin:
    """Mixin keys."""


@dataclass
class InelsHacsSelectEntityDescription(
    SelectEntityDescription, InelsHacsSelectEntityDescriptionMixin
):
        ...
        if hasattr(val.ha_value, "fan_speed"):
            entities.append(
                InelsHacsSelect(
                    ...
                    key="fan_speed",
                    index=-1,
                    description=InelsHacsSelectEntityDescription(
                        key="fan_speed",
                        name="Fan speed",
...
class InelsHacsSelect(InelsHacsBaseEntity, SelectEntity):
    """The platform class for select for home assistant."""

    entity_description: InelsHacsSelectEntityDescription
